Name:       blue-flame-os-logos
Version:    18.0.0
Release:    6%{?dist}
Summary:    Icons and pictures

Group:      System Environment/Base
URL:        https://github.com/blueflameos/blue-flame-os-logos/ 
Source0:    https://github.com/blueflameos/blue-flame-os-logos/archive/master.zip
#The KDE Logo is under a LGPL license (no version statement)
License:    GPLv2 and LGPLv2+
BuildArch:  noarch

Obsoletes:  redhat-logos
Obsoletes:  blue-flame-os-logos < 17.0.0-5
...
%description
The blue-flame-os-logos package contains various image files which can be
...
%description httpd
The blue-flame-os-logos-httpd package contains image files which can be used by
httpd.

%prep
%setup -q -n blue-flame-os-logos-master
%build
make
...
mkdir -p %{buildroot}%{_datadir}/firstboot/themes/blueflameos
for i in firstboot/* ; do
  install -p -m 644 $i %{buildroot}%{_datadir}/firstboot/themes/blueflameos
done
...
%changelog
* Fri Nov 16 2018 yucuf Sourani <youssef.m.sourani@gmail.com> - 18.0.0-6
